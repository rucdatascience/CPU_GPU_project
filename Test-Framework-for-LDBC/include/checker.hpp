...
void bfs_checker(graph_structure<double>& graph, std::vector<int>& cpu_res, int & is_pass) {
    // std::cout << "Checking BFS results..." << std::endl;
...
void wcc_checker(graph_structure<double>& graph, std::vector<std::vector<int>>& cpu_res, int & is_pass) {
    // std::cout << "Checking WCC results..." << std::endl;
...
void sssp_checker(graph_structure<double>& graph, std::vector<double>& cpu_res, int & is_pass) {
    // std::cout << "Checking SSSP results..." << std::endl;
...
void pr_checker(graph_structure<double>& graph, std::vector<double>& cpu_res, int & is_pass) {
    // std::cout << "Checking PageRank results..." << std::endl;
...
void simple_cdlp_check(graph_structure<double>& graph, std::vector<long long int>& cpu_res,int & is_pass) {
...
void cdlp_check(graph_structure<double>& graph, std::vector<string>& cpu_res, int & is_pass) {
    // std::cout << "Checking CDLP results..." << std::endl;
